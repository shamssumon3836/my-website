< !DOCTYPE html >
    ...
    < head >
    <? include '../head.php'; ?>
< title > Recurrence Relation Solver < /title> < link rel = "stylesheet"
type = "text/css"
href = "../styles.css" >
    < /head> < body >
    <? include '../nav_bar.php' ?>
...
action = "recur.php" >
    < table >
    < tr >
    < td > f( < input id = "initx1"
        onchange = "onChangeInitX1();"
        onkeydown = "onChangeInitX1();"
        onkeyup = "onChangeInitX1();"
        onkeydown = "onChangeInitX1();"
        onkeypress = "onChangeInitX1();"
        style = "width: 10px"
        type = "text"
        value = "<?php echo $initx1;?>"
        name = "initx1"
        width = 1 / > ) < /td> < td >= < /td> < td > < input style = "width: 40px"
type = "text"
value = "<?php echo $inity1;?>"
name = "inity1" > < /td> < /tr> < tr >
    < td > f( < input id = "initx2"
        readonly = ""
        style = "width: 10px"
        type = "text"
        value = "<?php echo $initx2?>"
        name = "initx2" > ) < /td> < td >= < /td> < td > < input style = "width: 40px"
type = "text"
value = "<?php echo $inity2;?>"
name = "inity2" > < /td> < /tr> < tr >
    < td > f(n) < /td> < td >= < /td> < td > < input style = "width: 40px"
type = "text"
value = "<?php echo $recur1;?>"
name = "recur1" > * f(n - 1) < /td> < td > + < /td> < td > < input style = "width: 40px"
type = "text"
value = "<?php echo $recur2;?>"
name = "recur2" > * f(n - 2) < /td> < /tr> < /table> < br / >
    < input type = "submit"
value = "Solve" >
    < /form> <? php
